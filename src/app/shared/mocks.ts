...
import { ActivatedRouteSnapshot, ActivatedRoute, UrlSegment, Params, Route, ParamMap } from '@angular/router';
...
export class MockDataService {
    ...
    getStates(): Observable<IState[]> {
        ...
        //     const state: IState = customer['state'];
        //     stateArray.push(state);
        // }
        // console.log(stateArray);
        // return of(stateArray);
        return of(states);
    }
}
...
export class MockActivatedRoute implements ActivatedRoute {
    ...
    data: Observable<import ('@angular/router').Data>;
    outlet: string;
...
export const states: IState[] = [
    ...
    {abbreviation: 'MP', name: 'Northern Marina Islands'},
    {abbreviation: 'HO', name: 'Ohio'},
